                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                  <div class="form-group mb-0">
                                    <label for="txtRuc" class="col-form-label col-form-label-sm">RNC:</label>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body1">
            <form>
              <input id="txtIdProductoTienda" class="model" name="IdProductoTienda" value="0" type="hidden" />
              <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label col-form-label-sm">Precio</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control form-control-sm model" id="txtPrecioVenta" name="IdPrecioVenta">
                </div>
