                                ...
                                <div class="card" style="background-color: #F7F7F7">
                                  <div class="card-body p-2">
                                      ...
                                      <div class="row collapse" id="collapse1">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtRazonSocialProveedor" class="col-form-label col-form-label-sm">RNC:</label>
                                ...
                                <div class="card">
                                  <div class="card-body p-2">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtRazonSocialProveedor" class="col-form-label col-form-label-sm">Descuento:</label>
                                              <input type="text" class="form-control form-control-sm model" readonly id="txtclientedescuento" name="RazonSocial" autocomplete="off">
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                              <div class="form-group mb-0">
                                                  <label for="btnBuscarCliente" class="col-form-label col-form-label-sm invisible">Buscar:</label>
                                                  <button id="btnBuscarCliente" type="button" class="btn btn-sm btn-secondary btn-block">Buscar</button>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                                ...
                                <div class="card">
                                  <div class="card-body p-2">
                                      ...
                                      <div class="row">
                                         <!-- <div class="col-sm-3">
                                            <div class="form-group mb-0">
                                              <label for="txtproductostock" class="col-form-label col-form-label-sm">Galones En Stock:</label>
                                          ...
                                          <div class="col-sm-3">
                                            <div class="form-group mb-0">
                                              ...
                                              <input type="text" placeholder="RD$" class="form-control form-control-sm model" readonly id="txtproductoprecio" name="Nombre" >
                                            </div>
                                          </div>
                                          <div class="col-sm-3">
                                            <div class="form-group mb-0">
                                              <label for="txtproductocantidad" class="col-form-label col-form-label-sm">Galones: <span class="required">*</span></label>
                      ...
                      <div class="row">
                          <div class="col-sm-6">
                              <div class="row">
                                  ...
                                  <div class="col-sm-4">
                                        <div class="input-group input-group-sm mb-2">
                                          <div class="input-group-prepend">
                                             <label class="input-group-text" for="inputGroupSelect01">ITBIS S/.</label>
                                          </div>
                          ...
                          <div class="col-sm-6">
                               <div class="row">
                                  ...
                                  <div class="col-sm-4">
                                         <button id="btncalcular" type="button" class="btn btn-sm btn-warning btn-block" style="margin-bottom: 8px;"><i class="fa fa-caret-right" aria-hidden="true"></i> Calcular</button>
                                    <div class="form-group mb-0">
                                              
                                              <select class="form-control form-control-sm model" id="cbometododepago" name="Rol">
                                  ...
                                  <div class="col-sm-4">
                                      ...
                                      <div class="input-group input-group-sm mb-2">
                                          <div class="input-group-prepend">
                                             <label class="input-group-text" for="inputGroupSelect01">Deuda /.</label>
                                          </div>
                                          <input id="txtdeuda" readonly type="text" class="form-control" >
                                        </div>
                                    </div>
                                 </div>
                          </div>
